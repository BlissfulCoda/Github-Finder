...
export default function Home(): JSX.Element {
  ...
  return (
    <motion.section
      ...
      className={`flex flex-col mb-7 page-layout transition-class  ${
        users.length > 0 ? "bg-black" : "tablet:bg-Earth"
      } justify-between 
        bg-no-repeat bg-[length:500px_500px] tablet:bg-black  bg-[center_top_6rem] sm:bg-[length:550px_550px] sm:bg-[center_top_5rem] tablet:bg-[length:560px_560px] tablet:bg-opacity-60 tablet:py-4 tablet:bg-[center_top_2rem]
