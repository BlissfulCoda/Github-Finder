  ...
  return (
    <Link to={`/user/${login}`}>
      <section className="p-1 ">
        ...
        hover:border-[3.7px] active:border-indigo-600 focus:border-indigo-600  hover:border-indigo-600 h-44 w-48 sm:w-52 sm:h-48 hover:ml-2 tablet:h-48 tablet:w-52 laptop:w-68 laptop:h-48 relative hover:duration-700 sm:hover:w-[200px] overflow-hidden"
        >
          <img
            src={avatar_url}
            alt="Profile"
